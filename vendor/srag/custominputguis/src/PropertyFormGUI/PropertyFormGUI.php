...
use srag\CustomInputGUIs\AttendanceList\MultiLineNewInputGUI\MultiLineNewInputGUI;
...
use srag\CustomInputGUIs\AttendanceList\TabsInputGUI\TabsInputGUITab;
...
abstract class PropertyFormGUI extends ilPropertyFormGUI
{
     ...
     * @deprecated
     */
    protected final function storeFormCheck()
    {
     ...
     * @deprecated
     */
    protected abstract function storeValue($key, $value)/*: void*/ ;
