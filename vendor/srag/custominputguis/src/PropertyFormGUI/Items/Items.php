...
namespace srag\CustomInputGUIs\AttendanceList\PropertyFormGUI\Items;
...
final class Items
{
     ...
     * @return mixed
     */
    public static function getter(/*object*/ $object, $property)
    {
     ...
     * @return mixed
     */
    public static function setter(/*object*/ $object, $property, $value)
    {
        $res = null;
