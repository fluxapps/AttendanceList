...
namespace srag\CustomInputGUIs\AttendanceList\MultiLineInputGUI;
...
use ilToolbarItem;
use ilUtil;
use srag\CustomInputGUIs\AttendanceList\GlyphGUI\GlyphGUI;
 ...
 *
 * @package    srag\CustomInputGUIs\AttendanceList\MultiLineInputGUI
 *
...
class MultiLineInputGUI extends ilFormPropertyGUI implements ilTableFilterItem, ilToolbarItem
{
     ...
     * @deprecated
     */
    public function addCustomAttribute($key, $value, $override = false)/*: void*/
    {
     ...
     * @deprecated
     */
    public function setTemplateDir($template_dir)/*: void*/
    {
     ...
     * @deprecated
     */
    public function setPositionMovable($position_movable)/*: void*/
    {
     ...
     * @deprecated
     */
    public function setShowInfo($show_info)/*: void*/
    {
     ...
     * @deprecated
     */
    public function setShowLabel($show_label)/*: void*/
    {
     ...
     * @deprecated
     */
    public function setShowLabelOnce($show_label_once)/*: void*/
    {
