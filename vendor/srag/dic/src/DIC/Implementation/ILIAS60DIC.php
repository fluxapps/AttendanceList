...
namespace srag\DIC\AttendanceList\DIC\Implementation;
...
use ilUIService;
use Session;
use srag\DIC\AttendanceList\DIC\AbstractDIC;

/**
 * Class ILIAS60DIC
 *
 * @package srag\DIC\AttendanceList\DIC\Implementation
 *
...
final class ILIAS60DIC extends AbstractDIC
{
     ...
     * @inheritDoc
     */
    public function bookingObjUseBook()
    {
     ...
     * @inheritDoc
     */
    public function certificateActiveValidator()
    {
     ...
     * @inheritDoc
     */
    public function javaScriptBinding()
    {
     ...
     * @inheritDoc
     */
    public function rendererLoader()
    {
     ...
     * @inheritDoc
     */
    public function resourceRegistry()
    {
