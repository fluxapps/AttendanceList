...
```php
if (\srag\Notifications4Plugin\AttendanceList\x\Notification\Repository::getInstance(\srag\Plugins\x\Notification\Notification\Notification::class, \srag\Plugins\x\Notification\Notification\Language\NotificationLanguage::class)
		->migrateFromOldGlobalPlugin(x::TEMPLATE_NAME) === null) {

	$notification = \srag\Notifications4Plugin\AttendanceList\x\Notification\Repository::getInstance(\srag\Plugins\x\Notification\Notification\Notification::class, \srag\Plugins\x\Notification\Notification\Language\NotificationLanguage::class)
		->factory()->newInstance();
	...
	\srag\Notifications4Plugin\AttendanceList\x\Notification\Repository::getInstance(\srag\Plugins\x\Notification\Notification\Notification::class, \srag\Plugins\x\Notification\Notification\Language\NotificationLanguage::class)
...
```php
...
use srag\Notifications4Plugin\AttendanceList\x\Utils\Notifications4PluginTrait;
...
class x {
...
...
// Your class must implement the interface `srag\Notifications4Plugin\AttendanceList\x\Sender\Sender`
```
...
Your class must implement the interface `srag\Notifications4Plugin\AttendanceList\x\Parser\Parser`
