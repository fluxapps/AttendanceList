...
final class Repository implements RepositoryInterface {
	 ...
	 */
	public static function getInstance($notification_class, $language_class) {
	 ...
	 * @param string $language_class
	 */
	private function __construct($notification_class, $language_class) {
	 ...
	 * @return string
	 */
	private function getNotificationsQuery($sort_by = null, $sort_by_direction = null, $limit_start = null, $limit_end = null) {
