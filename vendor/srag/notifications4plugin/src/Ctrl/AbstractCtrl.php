...
namespace srag\Notifications4Plugin\AttendanceList\Ctrl;
...
use srag\Notifications4Plugin\AttendanceList\UI\NotificationFormGUI;
use srag\Notifications4Plugin\AttendanceList\UI\NotificationsTableGUI;
use srag\Notifications4Plugin\AttendanceList\Utils\Notifications4PluginTrait;

/**
 * Class AbstractCtrl
 *
 * @package srag\Notifications4Plugin\AttendanceList\Ctrl
 *
...
abstract class AbstractCtrl implements CtrlInterface {
	 ...
	 */
	protected function getNotificationsTable($parent_cmd = self::CMD_LIST_NOTIFICATIONS) {
		return self::notificationUI()->withPlugin(self::plugin())->withCtrlClass($this)
			->notificationTable($parent_cmd, function ($sort_by = null, $sort_by_direction = null, $limit_start = null, $limit_end = null) {    return $this->getNotifications($sort_by, $sort_by_direction, $limit_start, $limit_end);
}, function () {
	 ...
	 */
	protected function getNotificationForm(Notification $notification) {
	 ...
	 */
	protected function getNotificationDeleteConfirmation(Notification $notification) {
	 ...
	 * @return array
	 */
	protected function getNotifications($sort_by = null, $sort_by_direction = null, $limit_start = null, $limit_end = null) {
	 ...
	 * @param string $cmd
	 */
	protected function redirect($cmd)/*: void*/ {
