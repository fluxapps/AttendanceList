...
//		);
		...
		return round(
			$this->getAttendanceStatuses(xaliChecklistEntry::STATUS_PRESENT) / ($this->getAttendanceStatuses(xaliChecklistEntry::STATUS_PRESENT) + $this->getAttendanceStatuses(xaliChecklistEntry::STATUS_ABSENT_EXCUSED)
