...
class srWeekdayInputGUI extends ilFormPropertyGUI {
	...
	function checkInput() {
		return is_array($_POST[$this->getPostVar()]) && (count($_POST[$this->getPostVar()]) <= 7);
	}
	...
	protected function render() {
		$tpl = new ilTemplate("tpl.weekday_input.html", true, true, 'Customizing/global/plugins/Services/Repository/RepositoryObject/AttendanceList');
